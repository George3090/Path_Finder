...
document.querySelector("#clear").addEventListener("click",(e)=>{clearGrid(0,false,true); e.target.disabled = true;
   document.querySelector("#clear-path").disabled = true; 
   document.querySelector("#maze-animation-recursive-backtracker").disabled = false;
   document.querySelector("#maze-prim-animation").disabled = false;});
...
function generateMaze(choice){
  ...
  document.querySelector("#maze-animation-recursive-backtracker").disabled = true;
  document.querySelector("#maze-prim-animation").disabled = true;
